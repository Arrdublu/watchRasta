...
const GoogleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" {...props}>
        <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-.97 2.53-2.09 3.31v2.76h3.57c2.08-1.92 3.28-4.74 3.28-8.08z" fill="#4285F4"/>
...
export default function LoginPage() {
  ...
  return (
    <div className="container py-16 md:py-24 flex items-center justify-center min-h-[calc(100vh-4rem)]">
      <Card className="w-full max-w-md bg-card/60 backdrop-blur-lg border-border/20">
        ...
        <CardContent>
          <Button variant="outline" className="w-full" onClick={handleGoogleSignIn} disabled={isGoogleSubmitting || isSubmitting}>
              {isGoogleSubmitting ? 'Signing in...' : <><GoogleIcon className="mr-2 h-5 w-5" /> Sign in with Google</>}
          </Button>
