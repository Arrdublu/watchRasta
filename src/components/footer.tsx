        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
          <div className="col-span-2 md:col-span-1 flex items-start flex-col">
            <Link href="/" className="flex items-center space-x-2 mb-4">
              <Image src="https://firebasestorage.googleapis.com/v0/b/watchrasta.firebasestorage.app/o/branding%2FHeader-icon.png?alt=media&token=ddfb823f-9d79-4f03-aed6-8f7ddfaecb80" alt="watchRasta icon" width={48} height={48} />
            </Link>
          </div>
